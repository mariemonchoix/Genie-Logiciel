...
Nous avons décidé de faire un pacemaker double. En effet, il existe deux types principaux de pacemakers en fonction du nombre de sondes ou fils électriques utilisés pour stimuler le cœur : les pacemakers simples (ou monocanaux) et les pacemakers doubles (ou bicanaux).
